...
def _ssim_loss(pred: torch.Tensor, target: torch.Tensor, data_range: float = 1.0) -> torch.Tensor:
    """
    ...
    kernel = _SSIM_WINDOW.view(1, 1, _SSIM_WIN_SIZE, _SSIM_WIN_SIZE).expand(3, 1, -1, -1)
...
class TotalLoss(nn.Module):
    ...
    def __init__(
        ...
        self.photo_loss   = PhotometricLoss(l1_weight, ssim_weight)
